export default function Brands(){
    return(
        <div className="flex flex-col sm-screen md-screen sm-screen-2 lg-screen gap-5 m-5 p-5 w-96 bg-[#ffffff] rounded-tl-xl rounded-tr-xl rounded-bl-xl rounded-br-xl ">
