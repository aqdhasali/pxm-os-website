export default function Jat(){
    return(
        <div className="m-5 flex gap-5 sm-screen md-screen lg-screen sm-screen-2 flex-col items-center justify-center w-96 bg-[#ffffff] rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl rounded-br-2xl">
