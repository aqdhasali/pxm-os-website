export default function ProductCatergories(){
    return(
        <div className="flex flex-col gap-5 rounded-tl-xl rounded-tr-xl rounded-bl-xl rounded-br-xl w-96 bg-[#ffffff] p-5 m-5 sm-screen md-screen lg-screen sm-screen-2">
