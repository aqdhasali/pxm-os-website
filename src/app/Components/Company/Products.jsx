export default function Product(){
    return (
        <div className="flex flex-col gap-5 rounded-tl-xl rounded-tr-xl rounded-bl-xl rounded-br-xl w-96 bg-[#ffffff] p-5 mb-20 m-5 sm-screen sm-screen-2 md-screen lg-screen">
