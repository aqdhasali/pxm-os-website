        ...
        <div className="flex flex-col sm-screen-2 sm-screen md-screen lg-screen gap-2 w-auto p-5 m-6 bg-[#ffffff] rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl rounded-br-2xl">
            ...
            <div className="flex gap-2">
                ...
                <div className="relative group">
                    ...
                    <div className="flex flex-col w-48 h-48 absolute top-full right-0 mb-2 hidden group-hover:flex items-center justify-center  rounded-md bg-[#f3f3f3] text-lg text-black">
                        <img className="w-28 sm-width" src="Ellipse14.svg"></img>
                        <p>Dark Walnut</p>
                    </div>
                </div>
